"""Phase 2 first baseline run — exp_143_dynamic_doc (= v11 + video).
...
from experiments.exp_143_dynamic_doc.phased_agent import PhasedReActAgent, PhasedAgentConfig
from experiments.exp_143_dynamic_doc.preamble import build_preamble
from experiments.exp_143_dynamic_doc.tools.registry import create_default_tool_registry
from experiments.exp_143_dynamic_doc.adaptive_vote import adaptive_vote

...
from experiments.exp_037_lenient_json.prompt import (
    REACT_SYSTEM_PROMPT,
    build_observation_prompt,
    build_system_prompt,
    build_task_prompt,
)
from experiments.exp_037_lenient_json.runtime import (
    AgentRunResult,
    AgentRuntimeState,
    StepRecord,
)
from experiments.exp_037_lenient_json.tools.registry import ToolRegistry
...
def _load_single_json_object(text: str) -> dict[str, object]:
    ...
    if remainder:
        # Strip benign trailing noise: closing braces, quotes, backticks, whitespace.
        # Only raise if alphanumeric content remains (indicates a real second object).
        cleaned_remainder = re.sub(r'[}\"\'\`\s]', "", remainder)

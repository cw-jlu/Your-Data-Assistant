...
from experiments.exp_037_lenient_json.agent import ReActAgent, ReActAgentConfig
from experiments.exp_037_lenient_json.config import AppConfig
from experiments.exp_037_lenient_json.preamble import build_preamble
from experiments.exp_037_lenient_json.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_037_lenient_json")

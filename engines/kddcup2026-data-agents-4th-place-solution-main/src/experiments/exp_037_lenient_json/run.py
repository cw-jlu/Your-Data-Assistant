"""Entry point for experiment exp_037_lenient_json.

Usage:
    python -m experiments.exp_037_lenient_json.run [COMMAND] [OPTIONS]
...
from experiments.exp_037_lenient_json.config import load_app_config
from experiments.exp_037_lenient_json.runner import (
    TaskRunArtifacts,

...
# ====================================================================
# exp_151 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_151 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_151 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_151 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_151 ablation: when EXP151_ANSWER_SHAPE / EXP151_PROSE are on, the

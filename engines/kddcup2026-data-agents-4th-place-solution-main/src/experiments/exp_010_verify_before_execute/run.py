"""Entry point for experiment exp_010_verify_before_execute.

Usage:
    python -m experiments.exp_010_verify_before_execute.run [COMMAND] [OPTIONS]
...
from experiments.exp_010_verify_before_execute.config import load_app_config
from experiments.exp_010_verify_before_execute.runner import (
    TaskRunArtifacts,

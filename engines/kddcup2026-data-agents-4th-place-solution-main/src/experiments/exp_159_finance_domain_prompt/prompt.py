...
# ====================================================================
# exp_159 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_159 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_159 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_159 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_159 ablation: when EXP159_ANSWER_SHAPE / EXP159_PROSE are on, the

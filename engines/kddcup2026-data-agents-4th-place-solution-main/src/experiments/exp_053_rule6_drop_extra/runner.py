...
from experiments.exp_053_rule6_drop_extra.agent import ReActAgent, ReActAgentConfig
from experiments.exp_053_rule6_drop_extra.config import AppConfig
from experiments.exp_053_rule6_drop_extra.preamble import build_preamble
from experiments.exp_053_rule6_drop_extra.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_053_rule6_drop_extra")

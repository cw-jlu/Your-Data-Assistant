"""Entry point for experiment exp_053_rule6_drop_extra.

Usage:
    python -m experiments.exp_053_rule6_drop_extra.run [COMMAND] [OPTIONS]
...
from experiments.exp_053_rule6_drop_extra.config import load_app_config
from experiments.exp_053_rule6_drop_extra.runner import (
    TaskRunArtifacts,

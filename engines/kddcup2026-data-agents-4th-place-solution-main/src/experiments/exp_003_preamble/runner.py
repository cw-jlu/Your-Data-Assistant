...
from experiments.exp_003_preamble.agent import ReActAgent, ReActAgentConfig
from experiments.exp_003_preamble.config import AppConfig
from experiments.exp_003_preamble.preamble import build_preamble
from experiments.exp_003_preamble.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_003_preamble")

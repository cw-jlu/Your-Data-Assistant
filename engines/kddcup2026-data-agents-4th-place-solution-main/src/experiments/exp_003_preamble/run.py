"""Entry point for experiment exp_003_preamble.

Usage:
    python -m experiments.exp_003_preamble.run [COMMAND] [OPTIONS]
...
from experiments.exp_003_preamble.config import load_app_config
from experiments.exp_003_preamble.runner import (
    TaskRunArtifacts,

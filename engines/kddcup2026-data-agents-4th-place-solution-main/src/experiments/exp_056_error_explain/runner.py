...
from experiments.exp_056_error_explain.agent import ReActAgent, ReActAgentConfig
from experiments.exp_056_error_explain.config import AppConfig
from experiments.exp_056_error_explain.preamble import build_preamble
from experiments.exp_056_error_explain.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_056_error_explain")

"""Entry point for experiment exp_045_adaptive_doc_search.

Usage:
    python -m experiments.exp_045_adaptive_doc_search.run [COMMAND] [OPTIONS]
...
from experiments.exp_045_adaptive_doc_search.config import load_app_config
from experiments.exp_045_adaptive_doc_search.runner import (
    TaskRunArtifacts,

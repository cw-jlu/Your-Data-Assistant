...
# ====================================================================
# exp_164 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_164 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_164 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_164 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_164 ablation: when EXP164_ANSWER_SHAPE / EXP164_PROSE are on, the

"""Entry point for experiment exp_099_schema_graph_fallback.

Usage:
    python -m experiments.exp_099_schema_graph_fallback.run [COMMAND] [OPTIONS]
...
from experiments.exp_099_schema_graph_fallback.config import load_app_config
from experiments.exp_099_schema_graph_fallback.runner import (
    TaskRunArtifacts,

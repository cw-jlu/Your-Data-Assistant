...
PHASE_NAME_TO_TOOLS = {
    ...
    "explore": ("list_context", "describe_data", "execute_sql", "read_doc",
                "grep", "consult_domain_db", "complete_phase"),
    "answer":  ("answer_from_sql", "complete_phase"),
    # VERIFY: include grep + consult_domain_db so cross-check can re-search
    # docs/schema reference for the answer's source value if needed.

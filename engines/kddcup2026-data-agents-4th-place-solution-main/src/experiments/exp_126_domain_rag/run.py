"""Entry point for experiment exp_126_domain_rag.

Usage:
    python -m experiments.exp_126_domain_rag.run [COMMAND] [OPTIONS]
...
from experiments.exp_126_domain_rag.config import load_app_config
from experiments.exp_126_domain_rag.runner import (
    TaskRunArtifacts,

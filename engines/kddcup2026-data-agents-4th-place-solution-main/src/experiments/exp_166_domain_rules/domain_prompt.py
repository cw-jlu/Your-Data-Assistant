...
- Decide which entity the question is about:
  ...
  - management company: id typically `InvestAdvisorCode` (基金管理人编码).
...
5. DISTINCT PATIENTS: "how many patients" = COUNT(DISTINCT person-id).
6. OUTPUT SHAPE: return only the column(s) literally asked for (usually one: a time / name / value).

"""Entry point for experiment exp_106_profile_size_guard_runner_fix.

Usage:
    python -m experiments.exp_106_profile_size_guard_runner_fix.run [COMMAND] [OPTIONS]
...
from experiments.exp_106_profile_size_guard_runner_fix.config import load_app_config
from experiments.exp_106_profile_size_guard_runner_fix.runner import (
    TaskRunArtifacts,

...
from experiments.exp_152_final_sql_guard.tools.filesystem import resolve_context_path
...
def index_cache_root() -> Path:
    root = Path(os.environ.get("EXP152_PROSE_INDEX_ROOT", "artifacts/prose_doc_index"))
...
def _load_doc_text(task: PublicTask, relative_path: str) -> str:
    ...
    if path.suffix.lower() == ".pdf":
        try:
            from experiments.exp_152_final_sql_guard.pdf_text_cache import read_cached_pdf_text

...
# ====================================================================
# exp_152 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_152 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_152 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_152 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_152 ablation: when EXP152_ANSWER_SHAPE / EXP152_PROSE are on, the

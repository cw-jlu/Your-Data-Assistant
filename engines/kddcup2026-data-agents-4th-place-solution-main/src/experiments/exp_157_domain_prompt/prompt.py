...
# ====================================================================
# exp_157 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_157 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_157 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_157 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_157 ablation: when EXP157_ANSWER_SHAPE / EXP157_PROSE are on, the

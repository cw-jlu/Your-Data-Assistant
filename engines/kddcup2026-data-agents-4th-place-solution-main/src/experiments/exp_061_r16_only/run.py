"""Entry point for experiment exp_061_r16_only.

Usage:
    python -m experiments.exp_061_r16_only.run [COMMAND] [OPTIONS]
...
from experiments.exp_061_r16_only.config import load_app_config
from experiments.exp_061_r16_only.runner import (
    TaskRunArtifacts,

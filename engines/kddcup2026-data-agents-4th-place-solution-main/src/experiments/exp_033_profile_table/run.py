"""Entry point for experiment exp_033_profile_table.

Usage:
    python -m experiments.exp_033_profile_table.run [COMMAND] [OPTIONS]
...
from experiments.exp_033_profile_table.config import load_app_config
from experiments.exp_033_profile_table.runner import (
    TaskRunArtifacts,

...
from experiments.exp_167_domain_pruner.tools.filesystem import resolve_context_path
...
def index_cache_root() -> Path:
    root = Path(os.environ.get("EXP167_PROSE_INDEX_ROOT", "artifacts/prose_doc_index"))

"""Entry point for experiment exp_101_rich_preamble.

Usage:
    python -m experiments.exp_101_rich_preamble.run [COMMAND] [OPTIONS]
...
from experiments.exp_101_rich_preamble.config import load_app_config
from experiments.exp_101_rich_preamble.runner import (
    TaskRunArtifacts,

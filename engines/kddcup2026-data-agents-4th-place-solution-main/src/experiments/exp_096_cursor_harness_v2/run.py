"""Entry point for experiment exp_096_cursor_harness_v2.

Usage:
    python -m experiments.exp_096_cursor_harness_v2.run [COMMAND] [OPTIONS]
...
from experiments.exp_096_cursor_harness_v2.config import load_app_config
from experiments.exp_096_cursor_harness_v2.runner import (
    TaskRunArtifacts,

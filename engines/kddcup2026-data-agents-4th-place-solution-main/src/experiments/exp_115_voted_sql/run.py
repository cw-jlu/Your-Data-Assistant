"""Entry point for experiment exp_115_voted_sql.

Usage:
    python -m experiments.exp_115_voted_sql.run [COMMAND] [OPTIONS]
...
from experiments.exp_115_voted_sql.config import load_app_config
from experiments.exp_115_voted_sql.runner import (
    TaskRunArtifacts,

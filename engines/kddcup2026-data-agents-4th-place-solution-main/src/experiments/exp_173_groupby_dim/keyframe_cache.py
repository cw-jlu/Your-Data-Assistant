...
def keyframe_cache_root() -> Path:
    root = Path(os.environ.get("EXP173_KEYFRAME_ROOT", "/tmp/kobushi_exp149_keyframe_cache"))
...
def _settings() -> dict[str, object]:
    ...
    return {
        "sample_fps": _float("EXP173_KEYFRAME_SAMPLE_FPS", 1.0),
        "hash_thresh": _int("EXP173_KEYFRAME_HASH_THRESH", 80),
        "diff_thresh": _float("EXP173_KEYFRAME_DIFF_THRESH", 7.0),
        "max_frames": _int("EXP173_KEYFRAME_MAX_IMAGES", 18),
    }

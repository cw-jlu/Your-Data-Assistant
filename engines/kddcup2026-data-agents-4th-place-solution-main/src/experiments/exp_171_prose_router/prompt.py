...
def allowed_tools_for_phase(phase: str) -> tuple[str, ...]:
    ...
    from experiments.exp_171_prose_router import flags
...
def build_phased_system_prompt(
    ...
    exp_149 ablation: when EXP171_ANSWER_SHAPE / EXP171_PROSE are on, the
    ...
    if flags.explore_shape_on() and phase == "explore":
        instr = instr + _EXPLORE_SHAPE_OVERRIDE

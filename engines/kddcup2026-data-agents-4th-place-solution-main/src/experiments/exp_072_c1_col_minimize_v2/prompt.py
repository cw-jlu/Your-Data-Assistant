...
18. Before calling any answer tool, compare each output column to the question text.
    Remove any column that the question does NOT explicitly request. When in doubt,
    fewer columns are safer — extra columns cost you points, missing column names do not.

"""Entry point for experiment exp_042_inline_spec_clean.

Usage:
    python -m experiments.exp_042_inline_spec_clean.run [COMMAND] [OPTIONS]
...
from experiments.exp_042_inline_spec_clean.config import load_app_config
from experiments.exp_042_inline_spec_clean.runner import (
    TaskRunArtifacts,

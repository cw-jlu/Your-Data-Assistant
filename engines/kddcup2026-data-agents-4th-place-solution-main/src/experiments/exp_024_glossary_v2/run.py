"""Entry point for experiment exp_024_glossary_v2.

Usage:
    python -m experiments.exp_024_glossary_v2.run [COMMAND] [OPTIONS]
...
from experiments.exp_024_glossary_v2.config import load_app_config
from experiments.exp_024_glossary_v2.runner import (
    TaskRunArtifacts,

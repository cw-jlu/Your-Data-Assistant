"""Entry point for experiment exp_089_r4_hybrid_think.

Usage:
    python -m experiments.exp_089_r4_hybrid_think.run [COMMAND] [OPTIONS]
...
from experiments.exp_089_r4_hybrid_think.config import load_app_config
from experiments.exp_089_r4_hybrid_think.runner import (
    TaskRunArtifacts,

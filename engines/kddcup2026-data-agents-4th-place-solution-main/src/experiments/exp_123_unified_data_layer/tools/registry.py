...
from experiments.exp_123_unified_data_layer.tools.filesystem import (
    grep_context,
    list_context_tree,
    read_doc_preview,
)
...
def _make_answer_from_sql_with_audit(
    ...
    *,
    ...
    """
    from experiments.exp_123_unified_data_layer.column_auditor import audit_columns, apply_audit

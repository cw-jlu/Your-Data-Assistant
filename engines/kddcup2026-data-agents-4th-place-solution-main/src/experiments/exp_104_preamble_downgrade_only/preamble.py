...
NOTE (exp_104): downgrade-only salvage of exp_099. The schema_graph hint
section is intentionally NOT included — exp_099 v3 confirmed it caused
−0.286 on hint-cohort tasks. Only the budget-time fallback infra is kept.
"""

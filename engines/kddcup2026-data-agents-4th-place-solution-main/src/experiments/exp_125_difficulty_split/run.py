"""Entry point for experiment exp_125_difficulty_split.

Usage:
    python -m experiments.exp_125_difficulty_split.run [COMMAND] [OPTIONS]
...
from experiments.exp_125_difficulty_split.config import load_app_config
from experiments.exp_125_difficulty_split.runner import (
    TaskRunArtifacts,

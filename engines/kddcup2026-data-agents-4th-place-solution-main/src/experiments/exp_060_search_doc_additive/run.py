"""Entry point for experiment exp_060_search_doc_additive.

Usage:
    python -m experiments.exp_060_search_doc_additive.run [COMMAND] [OPTIONS]
...
from experiments.exp_060_search_doc_additive.config import load_app_config
from experiments.exp_060_search_doc_additive.runner import (
    TaskRunArtifacts,

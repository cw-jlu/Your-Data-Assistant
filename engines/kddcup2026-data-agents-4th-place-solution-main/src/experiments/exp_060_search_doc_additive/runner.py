...
from experiments.exp_060_search_doc_additive.agent import ReActAgent, ReActAgentConfig
from experiments.exp_060_search_doc_additive.config import AppConfig
from experiments.exp_060_search_doc_additive.preamble import build_preamble
from experiments.exp_060_search_doc_additive.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_060_search_doc_additive")

"""Entry point for experiment exp_006_plan_no_preamble.

Usage:
    python -m experiments.exp_006_plan_no_preamble.run [COMMAND] [OPTIONS]
...
from experiments.exp_006_plan_no_preamble.config import load_app_config
from experiments.exp_006_plan_no_preamble.runner import (
    TaskRunArtifacts,

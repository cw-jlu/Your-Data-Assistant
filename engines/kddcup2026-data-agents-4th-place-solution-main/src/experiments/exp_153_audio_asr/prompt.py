...
# ====================================================================
# exp_153 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_153 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_153 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_153 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_153 ablation: when EXP153_ANSWER_SHAPE / EXP153_PROSE are on, the

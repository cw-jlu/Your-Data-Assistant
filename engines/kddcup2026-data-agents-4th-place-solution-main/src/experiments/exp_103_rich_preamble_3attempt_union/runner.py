...
from experiments.exp_103_rich_preamble_3attempt_union.agent import ReActAgent, ReActAgentConfig
from experiments.exp_103_rich_preamble_3attempt_union.config import AppConfig
from experiments.exp_103_rich_preamble_3attempt_union.preamble import build_preamble
from experiments.exp_103_rich_preamble_3attempt_union.tools.registry import (
    ToolRegistry,
...
_ATTEMPT_TEMPS: tuple[float, ...] = (0.6, 0.6, 0.7)  # Qwen3.5 R1 official 3-attempt union (k=1)

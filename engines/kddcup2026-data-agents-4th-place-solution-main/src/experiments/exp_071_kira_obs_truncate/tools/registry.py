...
from experiments.exp_071_kira_obs_truncate.tools.filesystem import (
    list_context_tree,
    read_csv_preview,
    read_doc_preview,
    read_json_preview,
...
from experiments.exp_071_kira_obs_truncate.tools.python_exec import (
    execute_python_code,
    execute_python_for_answer,
)
from experiments.exp_071_kira_obs_truncate.tools.sqlite import (
    execute_read_only_sql,
    inspect_sqlite_schema,
)

EXECUTE_PYTHON_TIMEOUT_SECONDS = 30
_OBS_MAX_BYTES = 30_000
...
def _truncate_obs(content: dict[str, Any], max_bytes: int = _OBS_MAX_BYTES) -> dict[str, Any]:
    ...
    Only truncates when the total JSON byte size exceeds max_bytes.
    Prioritises 'rows' (list) before 'output' (string) to preserve textual context.
    """
    import json

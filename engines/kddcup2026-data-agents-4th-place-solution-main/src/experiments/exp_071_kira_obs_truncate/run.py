"""Entry point for experiment exp_071_kira_obs_truncate.

Usage:
    python -m experiments.exp_071_kira_obs_truncate.run [COMMAND] [OPTIONS]
...
from experiments.exp_071_kira_obs_truncate.config import load_app_config
from experiments.exp_071_kira_obs_truncate.runner import (
    TaskRunArtifacts,

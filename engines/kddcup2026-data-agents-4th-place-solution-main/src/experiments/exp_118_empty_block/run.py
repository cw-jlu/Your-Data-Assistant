"""Entry point for experiment exp_118_empty_block.

Usage:
    python -m experiments.exp_118_empty_block.run [COMMAND] [OPTIONS]
...
from experiments.exp_118_empty_block.config import load_app_config
from experiments.exp_118_empty_block.runner import (
    TaskRunArtifacts,

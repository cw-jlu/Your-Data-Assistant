"""Entry point for experiment exp_052_filetype_labels.

Usage:
    python -m experiments.exp_052_filetype_labels.run [COMMAND] [OPTIONS]
...
from experiments.exp_052_filetype_labels.config import load_app_config
from experiments.exp_052_filetype_labels.runner import (
    TaskRunArtifacts,

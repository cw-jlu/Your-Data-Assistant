...
from experiments.exp_052_filetype_labels.agent import ReActAgent, ReActAgentConfig
from experiments.exp_052_filetype_labels.config import AppConfig
from experiments.exp_052_filetype_labels.preamble import build_preamble
from experiments.exp_052_filetype_labels.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_052_filetype_labels")

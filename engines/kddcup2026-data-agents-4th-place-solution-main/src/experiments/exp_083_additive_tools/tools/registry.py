...
from experiments.exp_083_additive_tools.tools.filesystem import (
...
from experiments.exp_083_additive_tools.tools.python_exec import (
    execute_python_code,
    execute_python_for_answer,
)
from experiments.exp_083_additive_tools.tools.sqlite import (
    ...
    specs = {
        ...
        "grep_file": ToolSpec(
            ...
            description=(
                ...
                "Use grep_file to find specific values or records in large files without "
                "loading all rows. Example: grep_file('csv/data.csv', 'Tokyo') to find "
                "rows containing 'Tokyo'."
            ),
            input_schema={
        ...
        "stat_file": ToolSpec(
            ...
            description=(
                ...
                "Use this to check file size or count rows in a CSV without loading the "
                "full file."
            ),

"""Entry point for experiment exp_008_thinking_off.

Usage:
    python -m experiments.exp_008_thinking_off.run [COMMAND] [OPTIONS]
...
from experiments.exp_008_thinking_off.config import load_app_config
from experiments.exp_008_thinking_off.runner import (
    TaskRunArtifacts,

...
from experiments.exp_008_thinking_off.agent import ReActAgent, ReActAgentConfig
from experiments.exp_008_thinking_off.config import AppConfig
from experiments.exp_008_thinking_off.preamble import build_preamble
from experiments.exp_008_thinking_off.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_008_thinking_off")

...
from experiments.exp_082_cursor_harness.agent import ReActAgent, ReActAgentConfig
from experiments.exp_082_cursor_harness.config import AppConfig
from experiments.exp_082_cursor_harness.preamble import build_preamble
from experiments.exp_082_cursor_harness.tools.registry import (
    ToolRegistry,
...
_ATTEMPT_TEMPS: tuple[float, ...] = (0.0,)  # single attempt (minimal preamble; workers=20)

"""Entry point for experiment exp_082_cursor_harness.

Usage:
    python -m experiments.exp_082_cursor_harness.run [COMMAND] [OPTIONS]
...
from experiments.exp_082_cursor_harness.config import load_app_config
from experiments.exp_082_cursor_harness.runner import (
    TaskRunArtifacts,

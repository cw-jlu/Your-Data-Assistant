...
# ====================================================================
# exp_155 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_155 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_155 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_155 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_155 ablation: when EXP155_ANSWER_SHAPE / EXP155_PROSE are on, the

...
# ====================================================================
# exp_147 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_147 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_147 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_147 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_147 ablation: when EXP147_ANSWER_SHAPE / EXP147_PROSE are on, the

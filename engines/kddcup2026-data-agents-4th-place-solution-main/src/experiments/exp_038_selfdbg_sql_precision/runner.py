...
from experiments.exp_038_selfdbg_sql_precision.agent import ReActAgent, ReActAgentConfig
from experiments.exp_038_selfdbg_sql_precision.config import AppConfig
from experiments.exp_038_selfdbg_sql_precision.preamble import build_preamble
from experiments.exp_038_selfdbg_sql_precision.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_038_selfdbg_sql_precision")

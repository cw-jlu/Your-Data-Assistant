"""Entry point for experiment exp_038_selfdbg_sql_precision.

Usage:
    python -m experiments.exp_038_selfdbg_sql_precision.run [COMMAND] [OPTIONS]
...
from experiments.exp_038_selfdbg_sql_precision.config import load_app_config
from experiments.exp_038_selfdbg_sql_precision.runner import (
    TaskRunArtifacts,

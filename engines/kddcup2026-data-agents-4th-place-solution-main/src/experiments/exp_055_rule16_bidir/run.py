"""Entry point for experiment exp_055_rule16_bidir.

Usage:
    python -m experiments.exp_055_rule16_bidir.run [COMMAND] [OPTIONS]
...
from experiments.exp_055_rule16_bidir.config import load_app_config
from experiments.exp_055_rule16_bidir.runner import (
    TaskRunArtifacts,

...
from experiments.exp_101_tool_discovery_additive.agent import ReActAgent, ReActAgentConfig
from experiments.exp_101_tool_discovery_additive.config import AppConfig
from experiments.exp_101_tool_discovery_additive.preamble import build_preamble
from experiments.exp_101_tool_discovery_additive.tools.registry import (
    ToolRegistry,
...
# (exp_101 [tool:discovery-additive], 2026-05-06: + grep_file / stat_file
#  additive on fulldata base; merge / sampling / preamble unchanged.)
...
# Derive experiment prefix from the parent directory name (e.g. "exp_101_tool_discovery_additive")

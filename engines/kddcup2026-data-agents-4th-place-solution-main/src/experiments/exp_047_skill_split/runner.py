...
from experiments.exp_047_skill_split.agent import ReActAgent, ReActAgentConfig
from experiments.exp_047_skill_split.config import AppConfig
from experiments.exp_047_skill_split.preamble import build_preamble
from experiments.exp_047_skill_split.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_047_skill_split")

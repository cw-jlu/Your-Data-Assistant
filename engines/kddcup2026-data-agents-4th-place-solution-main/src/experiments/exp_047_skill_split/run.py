"""Entry point for experiment exp_047_skill_split.

Usage:
    python -m experiments.exp_047_skill_split.run [COMMAND] [OPTIONS]
...
from experiments.exp_047_skill_split.config import load_app_config
from experiments.exp_047_skill_split.runner import (
    TaskRunArtifacts,

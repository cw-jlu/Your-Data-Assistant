"""Entry point for experiment exp_092_verify_rule_single.

Usage:
    python -m experiments.exp_092_verify_rule_single.run [COMMAND] [OPTIONS]
...
from experiments.exp_092_verify_rule_single.config import load_app_config
from experiments.exp_092_verify_rule_single.runner import (
    TaskRunArtifacts,

...
18. If you receive an observation containing `verifier_hint`, treat it as a one-shot
    structural review of your last answer attempt. Re-read the original question, decide
    whether the hint is correct, and either (a) submit a revised answer or (b) re-submit
    the same answer if you are confident. You only get this hint once per task.

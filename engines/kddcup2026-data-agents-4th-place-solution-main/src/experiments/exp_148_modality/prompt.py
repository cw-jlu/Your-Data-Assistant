...
17. ENTITY DESCRIPTOR (default). For questions of the form
    ...
    For Chinese finance schemas, user-facing entity names usually mean display
    or short names: A-share company/stock -> ChiNameAbbr or AShareAbbr; fund ->
    SecuAbbr or 基金简称. Use ChiName only for full/legal company name, and use
    SecuCode/AStockCode/FundCode only when the question asks for code/股票代码/
    证券代码/基金代码.
...
# ====================================================================
# exp_148 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_148 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_148 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_148 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_148 ablation: when EXP148_ANSWER_SHAPE / EXP148_PROSE are on, the

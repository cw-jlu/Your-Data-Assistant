"""Entry point for experiment exp_038_function_calling.

Usage:
    python -m experiments.exp_038_function_calling.run [COMMAND] [OPTIONS]
...
from experiments.exp_038_function_calling.config import load_app_config
from experiments.exp_038_function_calling.runner import (
    TaskRunArtifacts,

"""Entry point for experiment exp_062_sql_first_r16.

Usage:
    python -m experiments.exp_062_sql_first_r16.run [COMMAND] [OPTIONS]
...
from experiments.exp_062_sql_first_r16.config import load_app_config
from experiments.exp_062_sql_first_r16.runner import (
    TaskRunArtifacts,

...
When the context directory contains a `.db` (SQLite) database file, consider using
`answer_from_sql` as your first approach before loading tables into Python DataFrames.
Querying the database directly avoids DataFrame transcription errors and is usually faster.

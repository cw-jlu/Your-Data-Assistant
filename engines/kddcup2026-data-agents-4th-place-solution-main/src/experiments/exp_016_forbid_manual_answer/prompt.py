...
10. Use `answer` ONLY for single-cell literals (1 col × 1 row). For any table or query result, use `answer_from_sql` or `answer_from_python`. Calling `answer` with multi-row or multi-column data will score zero.

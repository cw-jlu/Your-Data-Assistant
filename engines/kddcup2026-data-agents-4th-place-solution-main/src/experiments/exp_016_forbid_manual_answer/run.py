"""Entry point for experiment exp_016_forbid_manual_answer.

Usage:
    python -m experiments.exp_016_forbid_manual_answer.run [COMMAND] [OPTIONS]
...
from experiments.exp_016_forbid_manual_answer.config import load_app_config
from experiments.exp_016_forbid_manual_answer.runner import (
    TaskRunArtifacts,

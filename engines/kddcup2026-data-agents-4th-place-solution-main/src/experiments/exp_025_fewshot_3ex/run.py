"""Entry point for experiment exp_025_fewshot_3ex.

Usage:
    python -m experiments.exp_025_fewshot_3ex.run [COMMAND] [OPTIONS]
...
from experiments.exp_025_fewshot_3ex.config import load_app_config
from experiments.exp_025_fewshot_3ex.runner import (
    TaskRunArtifacts,

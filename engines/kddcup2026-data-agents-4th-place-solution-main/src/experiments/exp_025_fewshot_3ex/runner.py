...
from experiments.exp_025_fewshot_3ex.agent import ReActAgent, ReActAgentConfig
from experiments.exp_025_fewshot_3ex.config import AppConfig
from experiments.exp_025_fewshot_3ex.preamble import build_preamble
from experiments.exp_025_fewshot_3ex.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_025_fewshot_3ex")

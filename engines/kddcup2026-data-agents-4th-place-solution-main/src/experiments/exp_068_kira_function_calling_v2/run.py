"""Entry point for experiment exp_068_kira_function_calling_v2.

Usage:
    python -m experiments.exp_068_kira_function_calling_v2.run [COMMAND] [OPTIONS]
...
from experiments.exp_068_kira_function_calling_v2.config import load_app_config
from experiments.exp_068_kira_function_calling_v2.runner import (
    TaskRunArtifacts,

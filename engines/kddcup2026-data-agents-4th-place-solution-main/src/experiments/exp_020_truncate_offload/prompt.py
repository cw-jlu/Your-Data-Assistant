...
11. When read_csv / read_json / read_doc returns an "offload_path", the full content was too
    large and has been saved to that path. Use read_offloaded with start_char and length to
    retrieve sections of it.

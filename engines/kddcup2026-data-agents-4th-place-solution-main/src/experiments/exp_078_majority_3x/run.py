"""Entry point for experiment exp_078_majority_3x.

Usage:
    python -m experiments.exp_078_majority_3x.run [COMMAND] [OPTIONS]
...
from experiments.exp_078_majority_3x.config import load_app_config
from experiments.exp_078_majority_3x.runner import (
    TaskRunArtifacts,

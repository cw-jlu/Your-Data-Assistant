...
from experiments.exp_078_majority_3x.agent import ReActAgent, ReActAgentConfig
from experiments.exp_078_majority_3x.config import AppConfig
from experiments.exp_078_majority_3x.preamble import build_preamble
from experiments.exp_078_majority_3x.tools.registry import (
    ToolRegistry,
...
_MAJORITY_K = 2  # 2 of 3 attempts must agree on a column signature
_ATTEMPT_TEMPS: tuple[float, ...] = (0.0, 0.3, 0.7)  # diversification

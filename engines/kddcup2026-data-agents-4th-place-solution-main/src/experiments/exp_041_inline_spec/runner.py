...
from experiments.exp_041_inline_spec.agent import ReActAgent, ReActAgentConfig
from experiments.exp_041_inline_spec.config import AppConfig
from experiments.exp_041_inline_spec.preamble import build_preamble
from experiments.exp_041_inline_spec.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_041_inline_spec")

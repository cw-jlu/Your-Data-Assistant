"""Entry point for experiment exp_041_inline_spec.

Usage:
    python -m experiments.exp_041_inline_spec.run [COMMAND] [OPTIONS]
...
from experiments.exp_041_inline_spec.config import load_app_config
from experiments.exp_041_inline_spec.runner import (
    TaskRunArtifacts,

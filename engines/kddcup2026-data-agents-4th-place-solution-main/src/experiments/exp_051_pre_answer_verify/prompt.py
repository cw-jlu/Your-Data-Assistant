...
17. Before calling `answer`, write a brief verification in your thought:
    (1) "Question asks for: [complete in ≤10 words]"
    (2) "My answer provides: [complete in ≤10 words]"
    (3) "Aligned: YES / NO"
    If "Aligned: NO", do NOT call `answer` yet — identify the mismatch and fix it first.

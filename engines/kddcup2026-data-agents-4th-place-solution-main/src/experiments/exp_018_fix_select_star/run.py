"""Entry point for experiment exp_018_fix_select_star.

Usage:
    python -m experiments.exp_018_fix_select_star.run [COMMAND] [OPTIONS]
...
from experiments.exp_018_fix_select_star.config import load_app_config
from experiments.exp_018_fix_select_star.runner import (
    TaskRunArtifacts,

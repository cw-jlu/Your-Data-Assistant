"""Entry point for experiment exp_035_fk_map_fence_fix.

Usage:
    python -m experiments.exp_035_fk_map_fence_fix.run [COMMAND] [OPTIONS]
...
from experiments.exp_035_fk_map_fence_fix.config import load_app_config
from experiments.exp_035_fk_map_fence_fix.runner import (
    TaskRunArtifacts,

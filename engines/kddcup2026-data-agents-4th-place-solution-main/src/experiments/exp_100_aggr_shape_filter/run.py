"""Entry point for experiment exp_100_aggr_shape_filter.

Usage:
    python -m experiments.exp_100_aggr_shape_filter.run [COMMAND] [OPTIONS]
...
from experiments.exp_100_aggr_shape_filter.config import load_app_config
from experiments.exp_100_aggr_shape_filter.runner import (
    TaskRunArtifacts,

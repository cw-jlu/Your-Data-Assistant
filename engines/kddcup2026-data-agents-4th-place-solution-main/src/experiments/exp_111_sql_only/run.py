"""Entry point for experiment exp_111_sql_only.

Usage:
    python -m experiments.exp_111_sql_only.run [COMMAND] [OPTIONS]
...
from experiments.exp_111_sql_only.config import load_app_config
from experiments.exp_111_sql_only.runner import (
    TaskRunArtifacts,

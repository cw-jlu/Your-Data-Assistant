"""Entry point for experiment exp_094_qwen_agent_runtime_swap.

Usage:
    python -m experiments.exp_094_qwen_agent_runtime_swap.run [COMMAND] [OPTIONS]
...
from experiments.exp_094_qwen_agent_runtime_swap.config import load_app_config
from experiments.exp_094_qwen_agent_runtime_swap.runner import (
    TaskRunArtifacts,

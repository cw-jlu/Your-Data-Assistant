...
from experiments.exp_028_fewshot_synthetic.agent import ReActAgent, ReActAgentConfig
from experiments.exp_028_fewshot_synthetic.config import AppConfig
from experiments.exp_028_fewshot_synthetic.preamble import build_preamble
from experiments.exp_028_fewshot_synthetic.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_028_fewshot_synthetic")

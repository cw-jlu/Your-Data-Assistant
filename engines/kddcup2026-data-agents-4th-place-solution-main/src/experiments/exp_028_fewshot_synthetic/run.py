"""Entry point for experiment exp_028_fewshot_synthetic.

Usage:
    python -m experiments.exp_028_fewshot_synthetic.run [COMMAND] [OPTIONS]
...
from experiments.exp_028_fewshot_synthetic.config import load_app_config
from experiments.exp_028_fewshot_synthetic.runner import (
    TaskRunArtifacts,

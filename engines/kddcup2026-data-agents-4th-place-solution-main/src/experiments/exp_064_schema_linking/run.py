"""Entry point for experiment exp_064_schema_linking.

Usage:
    python -m experiments.exp_064_schema_linking.run [COMMAND] [OPTIONS]
...
from experiments.exp_064_schema_linking.config import load_app_config
from experiments.exp_064_schema_linking.runner import (
    TaskRunArtifacts,

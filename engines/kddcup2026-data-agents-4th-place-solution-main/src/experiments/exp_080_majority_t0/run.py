"""Entry point for experiment exp_080_majority_t0.

Usage:
    python -m experiments.exp_080_majority_t0.run [COMMAND] [OPTIONS]
...
from experiments.exp_080_majority_t0.config import load_app_config
from experiments.exp_080_majority_t0.runner import (
    TaskRunArtifacts,

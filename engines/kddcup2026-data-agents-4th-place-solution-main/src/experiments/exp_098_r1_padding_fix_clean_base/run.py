"""Entry point for experiment exp_098_r1_padding_fix_clean_base.

Usage:
    python -m experiments.exp_098_r1_padding_fix_clean_base.run [COMMAND] [OPTIONS]
...
from experiments.exp_098_r1_padding_fix_clean_base.config import load_app_config
from experiments.exp_098_r1_padding_fix_clean_base.runner import (
    TaskRunArtifacts,

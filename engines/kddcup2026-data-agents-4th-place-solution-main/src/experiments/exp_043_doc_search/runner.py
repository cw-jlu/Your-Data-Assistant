...
from experiments.exp_043_doc_search.agent import ReActAgent, ReActAgentConfig
from experiments.exp_043_doc_search.config import AppConfig
from experiments.exp_043_doc_search.preamble import build_preamble
from experiments.exp_043_doc_search.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_043_doc_search")

"""Entry point for experiment exp_105_inspect_table_v2_single.

Usage:
    python -m experiments.exp_105_inspect_table_v2_single.run [COMMAND] [OPTIONS]
...
from experiments.exp_105_inspect_table_v2_single.config import load_app_config
from experiments.exp_105_inspect_table_v2_single.runner import (
    TaskRunArtifacts,

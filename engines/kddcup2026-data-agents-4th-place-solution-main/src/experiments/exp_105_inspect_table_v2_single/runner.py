...
from experiments.exp_105_inspect_table_v2_single.agent import ReActAgent, ReActAgentConfig
from experiments.exp_105_inspect_table_v2_single.config import AppConfig
from experiments.exp_105_inspect_table_v2_single.preamble import build_preamble
from experiments.exp_105_inspect_table_v2_single.tools.registry import (
    ToolRegistry,
...
_ATTEMPT_TEMPS: tuple[float, ...] = (0.6,)  # exp_105: single-attempt exploration class (URGENT default)

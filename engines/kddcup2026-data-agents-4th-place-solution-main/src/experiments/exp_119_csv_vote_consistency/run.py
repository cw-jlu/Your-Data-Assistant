"""Entry point for experiment exp_119_csv_vote_consistency.

Usage:
    python -m experiments.exp_119_csv_vote_consistency.run [COMMAND] [OPTIONS]
...
from experiments.exp_119_csv_vote_consistency.config import load_app_config
from experiments.exp_119_csv_vote_consistency.runner import (
    TaskRunArtifacts,

...
from experiments.exp_022_cascade_v3.prompt import (
    REACT_SYSTEM_PROMPT,
    build_observation_prompt,
    build_system_prompt,
    build_task_prompt,
)
from experiments.exp_022_cascade_v3.runtime import (
    AgentRunResult,
    AgentRuntimeState,
    StepRecord,
)
from experiments.exp_022_cascade_v3.tools.registry import ToolRegistry
...
class ReActAgent:
    ...
    def _build_messages(self, task: PublicTask, state: AgentRuntimeState) -> list[ModelMessage]:
        # Use self.system_prompt directly — cascade agents pre-build the full system prompt
        # (including tools + examples) and pass it here. Calling build_system_prompt would
        # double-inject the tool list.

...
# ====================================================================
# exp_160 LEVER ① — answer_shape_guard (DISTINCT explicit-only +
...
=== exp_160 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_160 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_160 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_160 ablation: when EXP160_ANSWER_SHAPE / EXP160_PROSE are on, the

...
from experiments.exp_066_kira_obs_truncate.agent import ReActAgent, ReActAgentConfig
from experiments.exp_066_kira_obs_truncate.config import AppConfig
from experiments.exp_066_kira_obs_truncate.preamble import build_preamble
from experiments.exp_066_kira_obs_truncate.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_066_kira_obs_truncate")

...
# ====================================================================
# exp_165 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_165 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_165 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_165 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_165 ablation: when EXP165_ANSWER_SHAPE / EXP165_PROSE are on, the

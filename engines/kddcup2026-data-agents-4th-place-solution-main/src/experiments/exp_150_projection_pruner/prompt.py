...
# ====================================================================
# exp_150 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_150 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_150 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_150 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_150 ablation: when EXP150_ANSWER_SHAPE / EXP150_PROSE are on, the

...
from experiments.exp_128_abl_a_att1.agent import ReActAgent, ReActAgentConfig
from experiments.exp_128_abl_a_att1.phased_agent import (
    PhasedReActAgent,
    PhasedAgentConfig,
)
from experiments.exp_128_abl_a_att1.adaptive_vote import adaptive_vote
from experiments.exp_128_abl_a_att1.config import AppConfig
from experiments.exp_128_abl_a_att1.preamble import build_preamble
from experiments.exp_128_abl_a_att1.tools.registry import (
    ToolRegistry,
...
_ATTEMPT_TEMPS: tuple[float, ...] = (0.6,)  # ABLATION A: n=1 single attempt

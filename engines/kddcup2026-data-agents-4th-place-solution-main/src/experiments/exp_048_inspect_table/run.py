"""Entry point for experiment exp_048_inspect_table.

Usage:
    python -m experiments.exp_048_inspect_table.run [COMMAND] [OPTIONS]
...
from experiments.exp_048_inspect_table.config import load_app_config
from experiments.exp_048_inspect_table.runner import (
    TaskRunArtifacts,

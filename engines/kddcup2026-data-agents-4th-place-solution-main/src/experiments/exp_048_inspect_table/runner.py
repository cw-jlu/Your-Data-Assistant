...
from experiments.exp_048_inspect_table.agent import ReActAgent, ReActAgentConfig
from experiments.exp_048_inspect_table.config import AppConfig
from experiments.exp_048_inspect_table.preamble import build_preamble
from experiments.exp_048_inspect_table.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_048_inspect_table")

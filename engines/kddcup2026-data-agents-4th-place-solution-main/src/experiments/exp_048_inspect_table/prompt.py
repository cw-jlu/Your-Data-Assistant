...
15. Use inspect_table to survey any CSV or SQLite file before writing queries.
    It returns column dtypes, null%, and top-5 rows in a single call — faster than
    calling inspect_sqlite_schema and SELECT LIMIT 5 separately.

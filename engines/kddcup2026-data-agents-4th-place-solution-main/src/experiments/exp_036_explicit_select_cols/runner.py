...
from experiments.exp_036_explicit_select_cols.agent import ReActAgent, ReActAgentConfig
from experiments.exp_036_explicit_select_cols.config import AppConfig
from experiments.exp_036_explicit_select_cols.preamble import build_preamble
from experiments.exp_036_explicit_select_cols.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_036_explicit_select_cols")

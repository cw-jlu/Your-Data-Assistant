"""Entry point for experiment exp_036_explicit_select_cols.

Usage:
    python -m experiments.exp_036_explicit_select_cols.run [COMMAND] [OPTIONS]
...
from experiments.exp_036_explicit_select_cols.config import load_app_config
from experiments.exp_036_explicit_select_cols.runner import (
    TaskRunArtifacts,

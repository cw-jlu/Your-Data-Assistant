...
from experiments.exp_013_sample_rich_preamble.agent import ReActAgent, ReActAgentConfig
from experiments.exp_013_sample_rich_preamble.config import AppConfig
from experiments.exp_013_sample_rich_preamble.preamble import build_preamble
from experiments.exp_013_sample_rich_preamble.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_013_sample_rich_preamble")

...
from experiments.exp_142_phase2_zh.profile import (
    csv_profile_text,
    json_array_profile,
...
def build_preamble(
    ...
    *,
    ...
    try:
        from experiments.exp_142_phase2_zh.tools.duckdb_unified import describe_catalog
    ...
    try:
        from experiments.exp_142_phase2_zh.math_advisor import generate_formula

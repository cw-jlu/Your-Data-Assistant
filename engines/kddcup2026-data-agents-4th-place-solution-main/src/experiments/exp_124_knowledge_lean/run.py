"""Entry point for experiment exp_124_knowledge_lean.

Usage:
    python -m experiments.exp_124_knowledge_lean.run [COMMAND] [OPTIONS]
...
from experiments.exp_124_knowledge_lean.config import load_app_config
from experiments.exp_124_knowledge_lean.runner import (
    TaskRunArtifacts,

"""Entry point for experiment exp_075_kira_obs_truncate_10k.

Usage:
    python -m experiments.exp_075_kira_obs_truncate_10k.run [COMMAND] [OPTIONS]
...
from experiments.exp_075_kira_obs_truncate_10k.config import load_app_config
from experiments.exp_075_kira_obs_truncate_10k.runner import (
    TaskRunArtifacts,

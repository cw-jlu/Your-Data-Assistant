...
from experiments.exp_142_phase2_baseline.agent import (
    parse_model_step,
)
from experiments.exp_142_phase2_baseline.prompt import (
    PHASE_NAME_TO_TOOLS,
    build_observation_prompt,
    build_phased_system_prompt,
    build_task_prompt,
)
from experiments.exp_142_phase2_baseline.runtime import (
    AgentRunResult,
    AgentRuntimeState,
    StepRecord,
)
from experiments.exp_142_phase2_baseline.tools.registry import ToolRegistry
...
class PhasedReActAgent:
    ...
    def _build_messages(
        ...
        # Phase 2: attach video to FIRST user message (PLAN phase) only.

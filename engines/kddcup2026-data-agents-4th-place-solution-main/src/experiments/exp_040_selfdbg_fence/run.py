"""Entry point for experiment exp_040_selfdbg_fence.

Usage:
    python -m experiments.exp_040_selfdbg_fence.run [COMMAND] [OPTIONS]
...
from experiments.exp_040_selfdbg_fence.config import load_app_config
from experiments.exp_040_selfdbg_fence.runner import (
    TaskRunArtifacts,

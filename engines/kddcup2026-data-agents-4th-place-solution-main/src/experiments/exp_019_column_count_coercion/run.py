"""Entry point for experiment exp_019_column_count_coercion.

Usage:
    python -m experiments.exp_019_column_count_coercion.run [COMMAND] [OPTIONS]
...
from experiments.exp_019_column_count_coercion.config import load_app_config
from experiments.exp_019_column_count_coercion.runner import (
    TaskRunArtifacts,

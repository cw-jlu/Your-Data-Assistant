...
# ====================================================================
# exp_154 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_154 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_154 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_154 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_154 ablation: when EXP154_ANSWER_SHAPE / EXP154_PROSE are on, the

"""Entry point for experiment exp_120_searchable_doc.

Usage:
    python -m experiments.exp_120_searchable_doc.run [COMMAND] [OPTIONS]
...
from experiments.exp_120_searchable_doc.config import load_app_config
from experiments.exp_120_searchable_doc.runner import (
    TaskRunArtifacts,

"""Entry point for experiment exp_046_tool_error_truncate.

Usage:
    python -m experiments.exp_046_tool_error_truncate.run [COMMAND] [OPTIONS]
...
from experiments.exp_046_tool_error_truncate.config import load_app_config
from experiments.exp_046_tool_error_truncate.runner import (
    TaskRunArtifacts,

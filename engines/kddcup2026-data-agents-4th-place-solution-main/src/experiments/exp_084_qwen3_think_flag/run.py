"""Entry point for experiment exp_084_qwen3_think_flag.

Usage:
    python -m experiments.exp_084_qwen3_think_flag.run [COMMAND] [OPTIONS]
...
from experiments.exp_084_qwen3_think_flag.config import load_app_config
from experiments.exp_084_qwen3_think_flag.runner import (
    TaskRunArtifacts,

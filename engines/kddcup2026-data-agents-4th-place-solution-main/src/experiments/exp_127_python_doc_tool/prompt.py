...
PHASE_NAME_TO_TOOLS = {
    ...
    "explore": ("list_context", "describe_data", "execute_sql", "read_doc",
                "grep", "consult_domain_db",
                "extract_structured", "complete_phase"),
    "answer":  ("answer_from_sql", "complete_phase"),
    # VERIFY: include grep + consult_domain_db + extract_structured so cross-checks
    # can re-search / re-extract values if needed.

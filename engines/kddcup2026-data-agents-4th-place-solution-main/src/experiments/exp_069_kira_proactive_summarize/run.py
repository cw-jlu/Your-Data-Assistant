"""Entry point for experiment exp_069_kira_proactive_summarize.

Usage:
    python -m experiments.exp_069_kira_proactive_summarize.run [COMMAND] [OPTIONS]
...
from experiments.exp_069_kira_proactive_summarize.config import load_app_config
from experiments.exp_069_kira_proactive_summarize.runner import (
    TaskRunArtifacts,

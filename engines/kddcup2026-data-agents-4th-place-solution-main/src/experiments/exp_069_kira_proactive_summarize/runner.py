...
from experiments.exp_069_kira_proactive_summarize.agent import ReActAgent, ReActAgentConfig
from experiments.exp_069_kira_proactive_summarize.config import AppConfig
from experiments.exp_069_kira_proactive_summarize.preamble import build_preamble
from experiments.exp_069_kira_proactive_summarize.tools.registry import (
    ToolRegistry,
    ...
    *,
    ...
    agent = ReActAgent(
        ...
        config=ReActAgentConfig(
            ...
            context_summarize_threshold=config.agent.context_summarize_threshold,
        ),

"""Entry point for experiment exp_026_fewshot_pathfix.

Usage:
    python -m experiments.exp_026_fewshot_pathfix.run [COMMAND] [OPTIONS]
...
from experiments.exp_026_fewshot_pathfix.config import load_app_config
from experiments.exp_026_fewshot_pathfix.runner import (
    TaskRunArtifacts,

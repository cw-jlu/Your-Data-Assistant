...
from experiments.exp_026_fewshot_pathfix.agent import ReActAgent, ReActAgentConfig
from experiments.exp_026_fewshot_pathfix.config import AppConfig
from experiments.exp_026_fewshot_pathfix.preamble import build_preamble
from experiments.exp_026_fewshot_pathfix.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_026_fewshot_pathfix")

...
from experiments.exp_027_loop_break.agent import ReActAgent, ReActAgentConfig
from experiments.exp_027_loop_break.config import AppConfig
from experiments.exp_027_loop_break.preamble import build_preamble
from experiments.exp_027_loop_break.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_027_loop_break")

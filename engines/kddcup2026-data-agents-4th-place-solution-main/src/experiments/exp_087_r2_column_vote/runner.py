...
from experiments.exp_087_r2_column_vote.agent import ReActAgent, ReActAgentConfig
from experiments.exp_087_r2_column_vote.config import AppConfig
from experiments.exp_087_r2_column_vote.preamble import build_preamble
from experiments.exp_087_r2_column_vote.tools.registry import (
    ToolRegistry,
...
_MAJORITY_K = 2  # ⌈n/2⌉ majority (k=2 of 3): keep signatures appearing in 2+ attempts
                 # R2 [aggr] column-signature majority vote on top of exp_086 union base.
                 # Trades raw recall for lower extras_ratio (with_extras was 3-7 in exp_086 n=2).
                 # Fallback to attempt 0 raw answer if all columns drop (preserves missing rate).
...
def _run_single_task_with_timeout(*, task_id: str, config: AppConfig) -> dict[str, Any]:
    """Run 3 parallel attempts at temperatures (0.6, 0.6, 0.7) and merge by

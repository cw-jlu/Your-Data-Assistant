"""Entry point for experiment exp_073_reason_min_steps_6.

Usage:
    python -m experiments.exp_073_reason_min_steps_6.run [COMMAND] [OPTIONS]
...
from experiments.exp_073_reason_min_steps_6.config import load_app_config
from experiments.exp_073_reason_min_steps_6.runner import (
    TaskRunArtifacts,

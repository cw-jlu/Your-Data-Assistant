"""Entry point for experiment exp_039_preamble_sqlite_cap.

Usage:
    python -m experiments.exp_039_preamble_sqlite_cap.run [COMMAND] [OPTIONS]
...
from experiments.exp_039_preamble_sqlite_cap.config import load_app_config
from experiments.exp_039_preamble_sqlite_cap.runner import (
    TaskRunArtifacts,

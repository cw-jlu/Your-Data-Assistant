...
from experiments.exp_113_subagent_orchestrator.prompt import (
    REACT_SYSTEM_PROMPT,
    build_observation_prompt,
    build_system_prompt,
    build_task_prompt,
)
from experiments.exp_113_subagent_orchestrator.runtime import (
    AgentRunResult,
    AgentRuntimeState,
    StepRecord,
)
from experiments.exp_113_subagent_orchestrator.tools.registry import ToolRegistry

# Tools that produce a terminal answer — blocked during early exploration.
ANSWER_TOOLS: frozenset[str] = frozenset({"answer", "answer_from_sql", "answer_from_sql_subagent"})
                        ...
                        StepRecord(
                            ...
                            observation={
                                ...
                                "error": (
                                    ...
                                    "Use describe_data, read_doc, or ask_sql_subagent first."
                                ),
                            },
                            ok=False,
                        )

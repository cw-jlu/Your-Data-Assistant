...
# ====================================================================
# exp_162 LEVER ① — answer_shape_guard (DISTINCT explicit-only +
...
=== exp_162 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_162 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_162 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_162 ablation: when EXP162_ANSWER_SHAPE / EXP162_PROSE are on, the

...
from experiments.exp_050_format_precommit.agent import ReActAgent, ReActAgentConfig
from experiments.exp_050_format_precommit.config import AppConfig
from experiments.exp_050_format_precommit.preamble import build_preamble
from experiments.exp_050_format_precommit.tools.registry import (
    ToolRegistry,
...
# Derive experiment prefix from the parent directory name (e.g. "exp_050_format_precommit")

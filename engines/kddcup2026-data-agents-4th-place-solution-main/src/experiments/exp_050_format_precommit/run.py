"""Entry point for experiment exp_050_format_precommit.

Usage:
    python -m experiments.exp_050_format_precommit.run [COMMAND] [OPTIONS]
...
from experiments.exp_050_format_precommit.config import load_app_config
from experiments.exp_050_format_precommit.runner import (
    TaskRunArtifacts,

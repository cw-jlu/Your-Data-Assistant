"""Entry point for experiment exp_039_answer_validation.

Usage:
    python -m experiments.exp_039_answer_validation.run [COMMAND] [OPTIONS]
...
from experiments.exp_039_answer_validation.config import load_app_config
from experiments.exp_039_answer_validation.runner import (
    TaskRunArtifacts,

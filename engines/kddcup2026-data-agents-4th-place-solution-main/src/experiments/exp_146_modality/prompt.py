...
20. AGGREGATION ONLY WHEN ASKED. For show/list/records/rows/details questions,
    preserve row grain; use SUM/AVG/COUNT only when explicitly requested.
...
For show/list/records/details questions, preserve row grain unless an
...
# ====================================================================
# exp_146 LEVER ① — answer_shape_guard (DISTINCT → JOIN-fanout-only +
...
=== exp_146 ANSWER-SHAPE OVERRIDE (supersedes the DISTINCT rule above) ===
...
=== exp_146 ANSWER-SHAPE OVERRIDE (supersedes the DUPLICATE SANITY step above) ===
...
# ====================================================================
# exp_146 LEVER ② — prose_doc_forced_read, H4a parse protocol. Appended to
...
def build_phased_system_prompt(
    ...
    exp_146 ablation: when EXP146_ANSWER_SHAPE / EXP146_PROSE are on, the

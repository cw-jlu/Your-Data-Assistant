...
from experiments.exp_146_modality.tools.filesystem import resolve_context_path
...
def index_cache_root() -> Path:
    root = Path(os.environ.get("EXP146_PROSE_INDEX_ROOT", "artifacts/prose_doc_index"))
...
def _load_doc_text(task: PublicTask, relative_path: str) -> str:
    ...
    if path.suffix.lower() == ".pdf":
        try:
            from experiments.exp_146_modality.pdf_text_cache import read_cached_pdf_text

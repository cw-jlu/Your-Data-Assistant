...
from experiments.exp_146_modality.runtime import StepRecord
...
- VIDEO_GROUNDED: video/keyframes provide source evidence.
  * If video/keyframes show the final displayed value/list/ranking/count
    (including DISPLAYED ANSWER), you MUST set sql_role=avoid.
  * For "how many"/"多少人" questions, a displayed count beats COUNT(DISTINCT ...).
...
def route_answer_source(
    *,
    ...
    if model is None or os.environ.get("EXP146_SOURCE_ROUTER_MODEL", "1").strip() == "0":

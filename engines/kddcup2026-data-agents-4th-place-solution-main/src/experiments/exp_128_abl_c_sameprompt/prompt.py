...
PHASE_NAME_TO_INSTRUCTION = {
    # ABLATION C: same prompt for all phases — phase tracking + tool whitelist
    # remain active, but the system prompt does NOT swap per phase.
    "plan":    PHASE_INSTRUCTION_PLAN,
    "explore": PHASE_INSTRUCTION_PLAN,
    "answer":  PHASE_INSTRUCTION_PLAN,
    "verify":  PHASE_INSTRUCTION_PLAN,
}

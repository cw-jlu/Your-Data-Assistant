...
from experiments.exp_128_abl_c_sameprompt.agent import ReActAgent, ReActAgentConfig
from experiments.exp_128_abl_c_sameprompt.phased_agent import (
    PhasedReActAgent,
    PhasedAgentConfig,
)
from experiments.exp_128_abl_c_sameprompt.adaptive_vote import adaptive_vote
from experiments.exp_128_abl_c_sameprompt.config import AppConfig
from experiments.exp_128_abl_c_sameprompt.preamble import build_preamble
from experiments.exp_128_abl_c_sameprompt.tools.registry import (
    ToolRegistry,
...
_ATTEMPT_TEMPS: tuple[float, ...] = (0.6,)  # ABLATION C: n=1 for fair comparison

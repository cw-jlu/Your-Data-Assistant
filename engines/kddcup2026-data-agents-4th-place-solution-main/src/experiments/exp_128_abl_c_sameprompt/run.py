"""Entry point for experiment exp_122_column_auditor.

Usage:
    python -m experiments.exp_128_abl_c_sameprompt.run [COMMAND] [OPTIONS]
...
from experiments.exp_128_abl_c_sameprompt.config import load_app_config
from experiments.exp_128_abl_c_sameprompt.runner import (
    TaskRunArtifacts,
